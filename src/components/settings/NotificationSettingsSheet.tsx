...
import { Bell, BellOff, TrendingUp, ArrowRightLeft, Shield, Check, X, ExternalLink, Info, AlertTriangle, Loader2, Bug, Copy, RefreshCw, Trash2, ChevronDown, ChevronUp } from "lucide-react";
              ...
              {debugOpen && (
                <div className="border-t border-border p-4 space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-xs font-mono">
                    ...
                    <div className="text-muted-foreground">UA</div>
                    <div className="break-all text-[10px]">{navigator.userAgent.substring(0, 80)}</div>
                  </div>

                  {/* Full token */}
                  {tokenValue && (
                    <div className="space-y-1">
                      <p className="text-xs font-medium text-muted-foreground">Full Token</p>
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    <Button
                      ...
                      className="text-xs"
                      onClick={() => {
                        const report = JSON.stringify({ fcmStatus, fcmError, tokenValue, platform: Capacitor.getPlatform(), ua: navigator.userAgent, log: debugLog }, null, 2);
                    ...
                    <Button
                      ...
                      onClick={reRegister}
                    >
                      <RefreshCw className="w-3 h-3 mr-1" /> Re-register
                    </Button>
                    <Button
                      variant="outline"
                      size="sm"
